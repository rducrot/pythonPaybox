...
class Transaction:
    ...
    def __init__(self, production=False, pbx_total=None, pbx_cmd=None, pbx_porteur=None, pbx_time=None,
                 pbx_repondre_a=None, pbx_refuse=None, pbx_effectue=None, pbx_annule=None, pbx_attente=None):

        self.production = production

        if self.production:
            self.action = "https://tpeweb.e-transactions.fr/php/"
            self.SECRET = settings.PBX_SECRET_KEY
        else:
        ...
        self.MANDATORY = {
            ...
            "PBX_RETOUR": 'Montant:M;Reference:R;Autorisation:A;Reponse:E;Transaction:S',
    ...
    def post_to_paybox(self):
        """ Returns three variables ready to be integrated in a hidden form, in a template
        """
    ...
    def construct_html_form(self):
        """ Returns a html form ready to be used (string)
        """
